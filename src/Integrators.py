...
# ------- ORBITAL PROPAGATION NON-DIMENSIONALIZED ------- #
...
# ------ ORBITAL PROPAGATION DIMENSIONALIZED ------ #
...
# - pos[ 3, Npoints ]: Position array [m]
# - vel[ 3, Npoints ]: Velocity array [m/sec]
def Kepler_Euler_Dimensionalized(pos_init, vel_init, t_initial, t_final, Npoints):
    dt = (t_final - t_initial) / (Npoints - 1.0)
    time = np.linspace(t_initial, t_final, Npoints)
...
# - pos[ 3, Npoints ]: Position array [m]
# - vel[ 3, Npoints ]: Velocity array [m/sec]
def Kepler_Verlet_Dimensionalized(pos_init, vel_init, t_initial, t_final, Npoints):
    dt = (t_final - t_initial) / (Npoints - 1.0)
    time = np.linspace(t_initial, t_final, Npoints)
...
# - pos[ 3, Npoints ]: Position array [m]
# - vel[ 3, Npoints ]: Velocity array [m/sec]
def Kepler_RK4_Dimensionalized(pos_init, vel_init, t_initial, t_final, Npoints):
    time = np.linspace(t_initial, t_final, Npoints)
    dt = (t_final - t_initial) / (Npoints - 1.0)
